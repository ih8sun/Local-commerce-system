...
namespace Presentacion
{
    public partial class Frm_Proveedor : Form
    {
        ...
        private Entidad.Proveedor regActual;



        cnProveedor lista_neg = new cnProveedor();
        ...
        {
            var oEntidad = new Entidad.Proveedor();
            try
            {
                if (string.IsNullOrWhiteSpace(txtproveedor.Text) || string.IsNullOrWhiteSpace(txtrazon.Text) || string.IsNullOrWhiteSpace(txttelefono.Text) || string.IsNullOrWhiteSpace(txtcelular.Text) || string.IsNullOrWhiteSpace(txtruc.Text) || string.IsNullOrWhiteSpace(txtdireccion.Text) || string.IsNullOrWhiteSpace(txtemail.Text))
                {
                ...
                {
                    MessageBox.Show("El celular tiene que tener 9 caracteres", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                ...
                else if (txtcelular.Text[0] != '9')
                {
                    MessageBox.Show("El telefono debe empezar con el número 9", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if (txtproveedor.Text.Length < 3)
                {
                    MessageBox.Show("El proveedor tiene que tener al menos 3 caracteres", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if (txtrazon.Text.Length < 3)
                {
                    MessageBox.Show("La razon tiene que tener al menos 3 caracteres", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else if (txtdireccion.Text.Length < 10)
                {
                    MessageBox.Show("La direccion tiene que tener al menos 10 caracteres", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                   
                    if (regActual != null)
                        oEntidad.idproveedor = regActual.idproveedor;

                    oEntidad.idproveedor = txtcodigo.Text.Trim();
                    oEntidad.nombres = txtproveedor.Text.Trim();
                    oEntidad.razon = txtrazon.Text.Trim();
                    oEntidad.direccion = txtdireccion.Text.Trim();
                    oEntidad.celular = txtcelular.Text.Trim();
                    ...
                    bool result = Negocio.cnProveedor.Grabar(oEntidad, true);
                    ...
                    {
                        MessageBox.Show("Ya existe un registro con la misma razon social y/o teléfono y/o celular y/o RUC y/o email", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    bool result = Negocio.cnProveedor.Grabar(oEntidad, false);
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Negocio.cnProveedor.Cambiar(oEntidad);
        ...
        private void gdvCliente_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtproveedor.Text = gdvCliente.CurrentRow.Cells["proveedor"].Value.ToString();
            ...
            txtcelular.Text = gdvCliente.CurrentRow.Cells["celular"].Value.ToString();
        ...
        {
            if (txtproveedor.Text.Length == 50 && e.KeyChar != (char)Keys.Back)
            {
                MessageBox.Show("El proveedor solo debe tener 50 caracteres máximo", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
            }
        ...
        private void txttelefono_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (txttelefono.Text.Length == 7 && e.KeyChar != (char)Keys.Back)
            {
                MessageBox.Show("El telefono debe de tener solo 7 dígitos", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
            }
        }
        private void txtcelular_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (txtcelular.Text.Length == 9 && e.KeyChar != (char)Keys.Back)
            {
                MessageBox.Show("El celular debe de tener solo 9 dígitos", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
            }
        }
