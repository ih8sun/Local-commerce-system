...
namespace Presentacion
{
    public partial class Frm_Cargo : Form
    {
        ...
        cnCargo lista_neg = new cnCargo();

        private Entidad.Cargo regActual;
        ...
        {
            var oEntidad = new Entidad.Cargo();
            try
            {
                ...
                else if (txtdescripcion.TextLength < 3)
                {
                    MessageBox.Show("El cargo debe de tener como minimo 3 caracteres", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    ...
                    bool result = Negocio.cnCargo.Grabar(oEntidad, true);
                    if (result)
                    {
                    ...
                    {
                        MessageBox.Show("Ya existe un registro con el mismo cargo", "Aviso...", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    bool result = Negocio.cnCargo.Grabar(oEntidad, false);
                    if (result)
                    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Negocio.cnCargo.Cambiar(oEntidad);
        ...
        private void gdvCliente_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtdescripcion.Text = gdvCliente.CurrentRow.Cells["cargo"].Value.ToString();
        ...
        private void txtdescripcion_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show("El cargo solo debe tener 50 caracteres máximo", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
            }
